...
//     if (!userEmail) {
//       console.error("ADMIN CHECK: user email not found");
//       return res.json({ success: true, isAdmin: false });
//     }

//     // ✅ read env safely
//     if (!process.env.ADMIN_EMAILS) {
//       console.error("ADMIN_EMAILS env variable is missing");
//       return res.json({ success: true, isAdmin: false });
//     }
...
import User from "../models/User.js";
import Movie from "../models/Movie.js";
import { clerkClient } from "@clerk/express"; // ✅ IMPORTANT IMPORT

/* =====================================================
   ADMIN CHECK (EMAIL-BASED – STRICT)
   ===================================================== */
export const isAdmin = async (req, res) => {
  try {
    const { userId } = req.auth;
