...
//     getToken,
//     image_base_url,
//     dashboardRefreshKey, // 🔥 THIS IS THE KEY
//   } = useAppContext();
...
//       fetchDashboardData();
//     }
//   }, [user, dashboardRefreshKey]); // ✅ MUST INCLUDE THIS
...
//         <div className="flex items-center gap-4 bg-primary/10 p-4 rounded">
//           <ChartLineIcon />
//           <div>
//             <p>Total Bookings</p>
...
//           <div>
//             <p>Active Shows</p>
//             <h2>{dashboardData.activeShows.length}</h2>
//           </div>
//         </div>
...
//         {dashboardData.activeShows.map((show) => (
//           <div key={show._id} className="w-56 bg-primary/10 p-3 rounded">
//             <img
//               src={image_base_url + show.movie.poster_path}
//               alt={show.movie.title}
//               className="h-60 w-full object-cover rounded"
//             />
//             <p className="mt-2 font-medium">{show.movie.title}</p>
//             <p className="text-sm">{dateFormat(show.showDateTime)}</p>
//           </div>
//         ))}
//       </div>
//     </>
...
const Dashboard = () => {
  const { user, getToken, image_base_url, dashboardRefreshKey } =
    useAppContext();
  ...
  return (
    <>
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
        ...
        {/* BOOKINGS */}
        <div className="flex items-center gap-6 p-6 rounded-xl bg-primary/10 border border-primary/20">
          <ChartLineIcon className="w-10 h-10 text-primary" />
          <div>
      ...
      {/* ================= ACTIVE SHOWS ================= */}
      <p className="mt-12 text-xl font-semibold">Active Shows</p>

      <div className="relative flex flex-wrap gap-6 mt-6">
        <BlurCircle top="120px" left="-10%" />
        ...
        {dashboardData.activeShows.map((show) => (
          <div
            key={show._id}
            className="w-64 rounded-xl overflow-hidden bg-primary/10 border border-primary/20 hover:-translate-y-1 transition"
          >
            <img
              src={image_base_url + show.movie.poster_path}
              alt={show.movie.title}
